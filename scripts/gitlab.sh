...
if [[ ! "$DATABASE_HOST"  && ! "$LOCALHOST"  ]]
    then
    echo "Uso: ./gitlab.sh <DATABASE_HOST> <EXTERNAL_IP>"
    exit -1
fi
...
sudo bash -c "echo 'git ALL=(ALL) ALL' > /etc/sudoers.d/git"
...
sudo -iu git cp /home/git/gitlab-shell/config.yml.example /home/git/gitlab-shell/config.yml
...
sudo -iu git cp /home/git/gitlab/config/gitlab.yml.example /home/git/gitlab/config/gitlab.yml
sudo -iu git mkdir /home/git/gitlab-satellites
sudo chmod u+rwx,g+rx,o-rwx /home/git/gitlab-satellites
sudo -iu git cp /home/git/gitlab/config/unicorn.rb.example /home/git/gitlab/config/unicorn.rb
sudo -iu git cp /home/git/gitlab/config/initializers/rack_attack.rb.example /home/git/gitlab/config/initializers/rack_attack.rb
sudo sed -i "s/gitlab_url: \"http:\/\/localhost\/\"/gitlab_url: \"http:\/\/$LOCALHOST:8090\/gitlab\//" /home/git/gitlab-shell/config.yml
...
sudo -iu git -H chmod o-rwx /home/git/gitlab/config/database.yml
