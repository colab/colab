...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('super_archives_vote', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 1, 19, 18, 8, 46, 813949), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Vote.created'
        db.delete_column('super_archives_vote', 'created')
