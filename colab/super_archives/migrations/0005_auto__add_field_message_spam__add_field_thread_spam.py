...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('super_archives_message', 'spam', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Thread.spam'
        db.add_column('super_archives_thread', 'spam', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Message.spam'
        db.delete_column('super_archives_message', 'spam')

        # Deleting field 'Thread.spam'
        db.delete_column('super_archives_thread', 'spam')
