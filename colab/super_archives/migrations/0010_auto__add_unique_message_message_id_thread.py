...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Message', fields ['message_id', 'thread']
        db.create_unique('super_archives_message', ['message_id', 'thread_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Message', fields ['message_id', 'thread']
        db.delete_unique('super_archives_message', ['message_id', 'thread_id'])
