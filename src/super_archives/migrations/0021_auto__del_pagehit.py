...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'super_archives_pagehit')


    def backwards(self, orm):
        # Adding model 'PageHit'
        db.create_table(u'super_archives_pagehit', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('hit_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('url_path', self.gf('django.db.models.fields.CharField')(max_length=2048, unique=True, db_index=True)),
        ))
        db.send_create_signal(u'super_archives', ['PageHit'])
    ...
    models = {
        ...
        u'super_archives.emailaddressvalidation': {
            ...
            'validation_key': ('django.db.models.fields.CharField', [], {'default': "'dabb0135cf6c436da11caf5dac7e8c10'", 'max_length': '32', 'null': 'True'})
        },
