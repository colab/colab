...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.webpage'
        db.alter_column(u'super_archives_userprofile', 'webpage', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'UserProfile.webpage'
        raise RuntimeError("Cannot reverse this migration. 'UserProfile.webpage' and its values cannot be restored.")
    ...
    models = {
        ...
        u'super_archives.emailaddress': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'emails'", 'null': 'True', 'to': u"orm['auth.User']"})
        },
