...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'EmailAddress', fields ['real_name']
        db.create_index('super_archives_emailaddress', ['real_name'])


    def backwards(self, orm):
        
        # Removing index on 'EmailAddress', fields ['real_name']
        db.delete_index('super_archives_emailaddress', ['real_name'])
