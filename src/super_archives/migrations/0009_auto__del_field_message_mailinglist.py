...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Message.mailinglist'
        db.delete_column('super_archives_message', 'mailinglist_id')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Message.mailinglist'
        raise RuntimeError("Cannot reverse this migration. 'Message.mailinglist' and its values cannot be restored.")
