...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Message', fields ['received_time']
        db.create_index(u'super_archives_message', ['received_time'])


    def backwards(self, orm):
        # Removing index on 'Message', fields ['received_time']
        db.delete_index(u'super_archives_message', ['received_time'])
    ...
    models = {
        ...
        u'super_archives.emailaddressvalidation': {
            ...
            'validation_key': ('django.db.models.fields.CharField', [], {'default': "'1775e2bdc5e341a9b9b8a6346eec1024'", 'max_length': '32', 'null': 'True'})
        },
