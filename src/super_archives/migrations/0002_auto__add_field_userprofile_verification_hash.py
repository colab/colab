...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.verification_hash'
        db.add_column('super_archives_userprofile', 'verification_hash', self.gf('django.db.models.fields.CharField')(max_length=32, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.verification_hash'
        db.delete_column('super_archives_userprofile', 'verification_hash')
