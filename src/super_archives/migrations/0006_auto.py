...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Message', fields ['subject_clean']
        db.create_index('super_archives_message', ['subject_clean'])

        # Adding index on 'Message', fields ['subject']
        db.create_index('super_archives_message', ['subject'])


    def backwards(self, orm):
        
        # Removing index on 'Message', fields ['subject']
        db.delete_index('super_archives_message', ['subject'])

        # Removing index on 'Message', fields ['subject_clean']
        db.delete_index('super_archives_message', ['subject_clean'])
