...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'accounts_user', (
            ...
            ('twitter', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('facebook', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('google_talk', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True)),
            ('github', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('webpage', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True)),
            ('verification_hash', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True)),
