...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Badge.title_en'
        db.add_column(u'badger_badge', 'title_en',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Badge.title_es'
        db.add_column(u'badger_badge', 'title_es',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Badge.description_en'
        db.add_column(u'badger_badge', 'description_en',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Badge.description_es'
        db.add_column(u'badger_badge', 'description_es',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Badge.description'
        db.alter_column(u'badger_badge', 'description', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Badge.title'
        db.alter_column(u'badger_badge', 'title', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):
        # Deleting field 'Badge.title_en'
        db.delete_column(u'badger_badge', 'title_en')

        # Deleting field 'Badge.title_es'
        db.delete_column(u'badger_badge', 'title_es')

        # Deleting field 'Badge.description_en'
        db.delete_column(u'badger_badge', 'description_en')

        # Deleting field 'Badge.description_es'
        db.delete_column(u'badger_badge', 'description_es')


        # Changing field 'Badge.description'
        db.alter_column(u'badger_badge', 'description', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

        # Changing field 'Badge.title'
        db.alter_column(u'badger_badge', 'title', self.gf('django.db.models.fields.CharField')(default='', max_length=200))
    ...
    models = {
        ...
        u'badger.badge': {
            ...
            'description_es': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
